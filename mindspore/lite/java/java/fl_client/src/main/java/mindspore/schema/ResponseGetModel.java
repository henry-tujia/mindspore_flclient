...
public final class ResponseGetModel extends Table {
  public static ResponseGetModel getRootAsResponseGetModel(ByteBuffer _bb) { return getRootAsResponseGetModel(_bb, new ResponseGetModel()); }
  public static ResponseGetModel getRootAsResponseGetModel(ByteBuffer _bb, ResponseGetModel obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; vtable_start = bb_pos - bb.getInt(bb_pos); vtable_size = bb.getShort(vtable_start); }
  public ResponseGetModel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createResponseGetModel(FlatBufferBuilder builder,
      int retcode,
      int reasonOffset,
      int iteration,
    ...
    ResponseGetModel.addTimestamp(builder, timestampOffset);
    ResponseGetModel.addFeatureMap(builder, feature_mapOffset);
    ResponseGetModel.addIteration(builder, iteration);
    ResponseGetModel.addReason(builder, reasonOffset);
    ResponseGetModel.addRetcode(builder, retcode);
    return ResponseGetModel.endResponseGetModel(builder);
  }

  public static void startResponseGetModel(FlatBufferBuilder builder) { builder.startObject(5); }
  ...
  public static int endResponseGetModel(FlatBufferBuilder builder) {
