...
public final class ReconstructSecret extends Table {
  public static ReconstructSecret getRootAsReconstructSecret(ByteBuffer _bb) { return getRootAsReconstructSecret(_bb, new ReconstructSecret()); }
  public static ReconstructSecret getRootAsReconstructSecret(ByteBuffer _bb, ReconstructSecret obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; vtable_start = bb_pos - bb.getInt(bb_pos); vtable_size = bb.getShort(vtable_start); }
  public ReconstructSecret __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createReconstructSecret(FlatBufferBuilder builder,
      int retcode,
      int reasonOffset,
      int iteration,
      int next_req_timeOffset) {
    builder.startObject(4);
    ReconstructSecret.addNextReqTime(builder, next_req_timeOffset);
    ReconstructSecret.addIteration(builder, iteration);
    ReconstructSecret.addReason(builder, reasonOffset);
    ReconstructSecret.addRetcode(builder, retcode);
    return ReconstructSecret.endReconstructSecret(builder);
  }

  public static void startReconstructSecret(FlatBufferBuilder builder) { builder.startObject(4); }
  ...
  public static int endReconstructSecret(FlatBufferBuilder builder) {
