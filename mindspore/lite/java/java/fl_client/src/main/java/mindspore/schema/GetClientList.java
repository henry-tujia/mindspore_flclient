...
public final class GetClientList extends Table {
  public static GetClientList getRootAsGetClientList(ByteBuffer _bb) { return getRootAsGetClientList(_bb, new GetClientList()); }
  public static GetClientList getRootAsGetClientList(ByteBuffer _bb, GetClientList obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; vtable_start = bb_pos - bb.getInt(bb_pos); vtable_size = bb.getShort(vtable_start); }
  public GetClientList __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createGetClientList(FlatBufferBuilder builder,
      int fl_idOffset,
      int iteration,
      int timestampOffset) {
    builder.startObject(3);
    GetClientList.addTimestamp(builder, timestampOffset);
    GetClientList.addIteration(builder, iteration);
    GetClientList.addFlId(builder, fl_idOffset);
    return GetClientList.endGetClientList(builder);
  }

  public static void startGetClientList(FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static int endGetClientList(FlatBufferBuilder builder) {
