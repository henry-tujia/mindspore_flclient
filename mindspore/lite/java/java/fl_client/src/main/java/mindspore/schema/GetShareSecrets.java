...
public final class GetShareSecrets extends Table {
  public static GetShareSecrets getRootAsGetShareSecrets(ByteBuffer _bb) { return getRootAsGetShareSecrets(_bb, new GetShareSecrets()); }
  public static GetShareSecrets getRootAsGetShareSecrets(ByteBuffer _bb, GetShareSecrets obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; vtable_start = bb_pos - bb.getInt(bb_pos); vtable_size = bb.getShort(vtable_start); }
  public GetShareSecrets __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createGetShareSecrets(FlatBufferBuilder builder,
      int fl_idOffset,
      int iteration,
      int timestampOffset) {
    builder.startObject(3);
    GetShareSecrets.addTimestamp(builder, timestampOffset);
    GetShareSecrets.addIteration(builder, iteration);
    GetShareSecrets.addFlId(builder, fl_idOffset);
    return GetShareSecrets.endGetShareSecrets(builder);
  }

  public static void startGetShareSecrets(FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static int endGetShareSecrets(FlatBufferBuilder builder) {
