...
public final class ResponseAsyncGetModel extends Table {
  public static ResponseAsyncGetModel getRootAsResponseAsyncGetModel(ByteBuffer _bb) { return getRootAsResponseAsyncGetModel(_bb, new ResponseAsyncGetModel()); }
  public static ResponseAsyncGetModel getRootAsResponseAsyncGetModel(ByteBuffer _bb, ResponseAsyncGetModel obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; vtable_start = bb_pos - bb.getInt(bb_pos); vtable_size = bb.getShort(vtable_start); }
  public ResponseAsyncGetModel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createResponseAsyncGetModel(FlatBufferBuilder builder,
      int retcode,
      int reasonOffset,
      int iteration,
      int feature_mapOffset) {
    builder.startObject(4);
    ResponseAsyncGetModel.addFeatureMap(builder, feature_mapOffset);
    ResponseAsyncGetModel.addIteration(builder, iteration);
    ResponseAsyncGetModel.addReason(builder, reasonOffset);
    ResponseAsyncGetModel.addRetcode(builder, retcode);
    return ResponseAsyncGetModel.endResponseAsyncGetModel(builder);
  }

  public static void startResponseAsyncGetModel(FlatBufferBuilder builder) { builder.startObject(4); }
  ...
  public static int endResponseAsyncGetModel(FlatBufferBuilder builder) {
